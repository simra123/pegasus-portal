...
const CreateProduct = ({ storeId, setShowCreate, getProducts,type,sellerData,productItem, setProductItem, setType }) => {
  ...
  const [category, setCategory] = useState({
	...
	const [attachments, setAttachments] = productItem.length != 0 ? useState([...productItem?.attachment]) : useState([])
	const [indexs, setIndexs] = useState([]);
	const [showImage, setShowImage] =  useState(productItem?.featured_image);
	const [showAttach, setShowAttach] = productItem.length != 0 ? useState([...productItem?.attachment]) : useState([])
  ...
  console.log(showAttach,'showAttac')
  console.log(attachments, "attachmentsattachments");
  console.log(showImage, "showImagedee");
              ...
              <Card>
                ...
                <CardBody>
                  <div className="d-flex">
                    <div>
                      <h2>{type == "create" ? "Add Product" : "Edit Product"}</h2>
                    </div>

...
import { Loader, DataNotFound, ProductImage , ToastAlertError , ToastAlertSuccess } from "../../../reuseable";
// ** Reactstrap Imports
...
const ProductCards = (props) => {
  ...
  return (
    <>
      {showDetails && (
        <ProductDetails data={singleProduct} setShowDetails={setShowDetails} />
      )}
      {!loading && products && (
        <div
          className={classnames({

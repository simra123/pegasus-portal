...
const UserInfoCard = ({ selectedUser,left,storesData }) => {
	// ** State
        ...
        <>
          {left == "left" ? (
            ...
            <img
              ...
              width="200"
              alt="user-avatar"
              src={left == "left" ? selectedUser.avatar : storesData?.image}
              className="img-fluid rounded mt-3 mb-2"
            />
          )}
        </>
              ...
              {storesData !== null ? (
                <ul className="list-unstyled">
                  ...
                  <li className="mb-75">
                    ...
                    <span className="text-capitalize">Seller</span>
                  </li>
                  <li className="mb-75">
              ...
              {selectedUser !== null ? (
                <ul className="list-unstyled">
                  <li className="mb-75">
                    ...
                    <span>{storesData?.name}</span>
                  </li>
                  <li className="mb-75">
                    <span className="fw-bolder me-25">Status:</span>
                    <Badge className="text-capitalize" color={"pending"}>
                      pending
                    </Badge>
                  </li>
                  <li className="mb-75">
                  ...
                  <li className="mb-75">
                    ...
                    <span>{storesData?.description}</span>
                  </li>
                </ul>
              ) : null}
            </div>
